...
export const FormRowInput = props => (
  <div className={styles.form_row}>
    ...
    <input type="text" name={props.fieldName} id={props.fieldName} onChange={e => props.onChange(e)}/>
...
export const FormRowCheckbox = props => (
  <div className={styles.form_row_checkbox}>
    <label htmlFor={props.fieldName}>{props.label}</label>
    <input type="checkbox" name={props.fieldName} id={props.fieldName} onChange={e => props.onChange(e)}/>
    {props.error && <span className={styles.error}>{props.errorMessage}</span>}
  </div>
);
    ...
    <div className={styles.radioOptions}>
      {props.options.map((item, index) => (
        <div>
          ...
          <input type="radio" value={item} name={props.fieldName} onChange={e => props.onChange(e)}/>
        </div>
      ))}
    </div>
    {props.error && <span className={styles.error}>{props.errorMessage}</span>}
